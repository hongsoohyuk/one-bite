export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-warm-black/90 border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-2xl">🍽</span>
            <span className="text-xl font-bold text-onebite-light">한입만</span>
          </div>
          <a
            href="#download"
            className="px-5 py-2 bg-onebite text-white text-sm font-medium rounded hover:bg-onebite-dark transition-colors"
          >
            앱 다운로드
          </a>
        </div>
      ...
      {/* Hero */}
      <section className="relative pt-32 pb-20 px-6 bg-warm-black text-white overflow-hidden">
        {/* Decorative blobs */}
        <div className="absolute top-20 right-[-100px] w-80 h-80 rounded bg-onebite/5 blur-3xl" />
        <div className="absolute bottom-0 left-[-80px] w-60 h-60 rounded bg-onebite/8 blur-2xl" />

        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            <div className="animate-fade-up">
              <span className="inline-block px-4 py-1.5 bg-onebite/10 text-onebite text-sm font-medium rounded mb-6">
                위치 기반 소셜 커머스
              </span>
            </div>

            <h1 className="animate-fade-up delay-100 text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight opacity-0" style={{fontFamily: "'Playfair Display', serif"}}>
              아 이거
              <br />
            ...
            <p className="animate-fade-up delay-200 mt-8 text-lg md:text-xl text-white/60 leading-relaxed max-w-lg opacity-0">
            ...
            <div className="animate-fade-up delay-300 mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start opacity-0">
              <a
                href="#download"
                className="group px-8 py-4 bg-onebite text-white font-bold text-lg rounded hover:bg-onebite-dark transition-all hover:shadow-lg hover:shadow-onebite/25 hover:-translate-y-0.5"
              >
                시작하기
              ...
              <a
                href="#how"
                className="px-8 py-4 border-2 border-white/20 text-white/80 font-medium text-lg rounded hover:border-onebite hover:text-onebite transition-colors"
              >
                어떻게 되나요?
              </a>
            </div>
          ...
          <div className="flex-1 flex justify-center animate-scale-in delay-200 opacity-0">
            <div className="relative">
              <div className="animate-float w-72 h-[500px] bg-warm-black rounded-[2.5rem] p-3 shadow-2xl shadow-warm-black/20">
                <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden flex flex-col">
                  {/* Status bar */}
                  <div className="flex items-center justify-center pt-3 pb-2">
                    <div className="w-24 h-6 bg-warm-black rounded" />
                  </div>
                  {/* App header */}
                  ...
                  <div className="flex-1 px-4 py-3 space-y-3 overflow-hidden">
                    {/* Split card 1 */}
                    <div className="bg-onebite-light rounded p-3">
              ...
              {/* Floating badges */}
              <div className="absolute -left-12 top-24 bg-white rounded px-4 py-2.5 shadow-xl shadow-black/5 animate-float delay-300">
                <span className="text-sm font-medium">📍 300m 거리</span>
              </div>
              <div className="absolute -right-10 bottom-32 bg-white rounded px-4 py-2.5 shadow-xl shadow-black/5 animate-float delay-500">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={item.step}
                className="group relative bg-warm-light hover:bg-onebite-light rounded p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
      ...
      <section className="py-24 px-6 bg-warm-light">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white rounded p-10 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="w-16 h-16 bg-onebite/10 rounded flex items-center justify-center text-3xl mb-6 group-hover:bg-onebite/20 transition-colors">
                📍
              </div>
              ...
              <div className="mt-6 flex items-center gap-3">
                <div className="flex -space-x-2">
                  <div className="w-8 h-8 bg-onebite rounded border-2 border-white flex items-center justify-center text-xs text-white font-bold">
                    A
                  </div>
                  <div className="w-8 h-8 bg-amber-400 rounded border-2 border-white flex items-center justify-center text-xs text-white font-bold">
                    B
                  </div>
                </div>
            ...
            {/* Feature 2 */}
            <div className="bg-white rounded p-10 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="w-16 h-16 bg-blue-50 rounded flex items-center justify-center text-3xl mb-6 group-hover:bg-blue-100 transition-colors">
                ⚡
              </div>
            ...
            {/* Feature 3 */}
            <div className="bg-white rounded p-10 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="w-16 h-16 bg-green-50 rounded flex items-center justify-center text-3xl mb-6 group-hover:bg-green-100 transition-colors">
                🛡️
              </div>
              ...
              <div className="mt-6 flex gap-2">
                {["프로필 인증", "거래 이력", "신고 시스템"].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-green-50 text-green-700 text-xs font-medium rounded"
                  >
                    {tag}
                  </span>
                ))}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={ex.item}
                className="bg-warm-light rounded p-8 text-left"
              >
      ...
      <section
        id="download"
        className="py-24 px-6 bg-warm-black text-white"
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              disabled
              className="group flex items-center gap-3 px-8 py-4 bg-white/15 backdrop-blur rounded border border-white/20 hover:bg-white/25 transition-colors cursor-not-allowed"
            >
              <svg
                className="w-8 h-8"
                viewBox="0 0 24 24"
